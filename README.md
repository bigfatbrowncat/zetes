...
If you want to see some demo applications that show up zetes features, take a look at [zetes-examples](https://github.com/bigfatbrowncat/zetes-examples) project.
