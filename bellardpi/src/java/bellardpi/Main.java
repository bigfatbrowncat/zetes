/*
 * Fabrice Bellard's comment from the original pi.c:
 * 
...
/*
 * My addition:
 * The original pi.c has been taken from http://bellard.org/pi/pi.c
 *
 * I added a plain loop here to calculate digits of pi from 1 to n instead
 * of calculating digits around n-th
 * 
 * And after that I translated the code into Java
 */
...
public class Main {
	...
	{
		return (int)(((long)a * (long)b) % m); //(int) (((double) a * (double) b) % m);
	}
	...
	public static void main(String[] args)
	{
		...
		for (n = 1; n <= nmax; n += 9) {
			...
			System.out.print((int) (sum * 1e9));

		}
		System.out.println();

		long finish = System.currentTimeMillis();
		System.out.println("Elapsed time to calculate " + nmax + " digits: " + (finish - start) / 1000 + " seconds");
